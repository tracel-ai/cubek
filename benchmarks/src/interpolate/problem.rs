...
use cubek::interpolate::definition::{
    InterpolateBackwardProblem, InterpolateBenchProblem, InterpolateMode, InterpolateOptions,
    InterpolateProblem,
};

pub fn problems() -> Vec<CatalogEntry<InterpolateBenchProblem>> {
    vec![
        // Nearest
        CatalogEntry::new(
            "NEAREST_UPSAMPLE_1_BATCH_3_CHANNELS_2048X2048_TO_4096X4096",
            "Nearest upsample (b=1 h=2048 w=2048 c=3 -> 4096x4096)",
            InterpolateBenchProblem::Interpolate(InterpolateProblem {
        ...
        CatalogEntry::new(
            "NEAREST_UPSAMPLE_1_BATCH_3_CHANNELS_2048X2048_TO_4096X4096",
            "Nearest upsample (b=1 h=2048 w=2048 c=3 -> 4096x4096)",
            InterpolateBenchProblem::InterpolateBackward(InterpolateBackwardProblem {
