...
use cubek_resample::definition::{
    ...
    ResampleAxis, ResampleAxisArgs, Semiring,
};
...
fn resample_1d_identity_test() {
    ...
    let resample_args = ResampleArgs::new()
        .with_resample_axis_args(ResampleAxisArgs::new(PlacementArgs::identity()));
...
fn resample_1d_test() {
    ...
    let resample_args = ResampleArgs::new()
        .with_resample_axis_args(ResampleAxisArgs::new(PlacementArgs::continuous(0.5, 0.0)));
