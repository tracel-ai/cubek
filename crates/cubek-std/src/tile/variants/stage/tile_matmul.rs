use crate::{
    StageIdent,
    stage::SwizzleMode,
    tile::{CmmaMatmul, InterleavedMatmul, MmaMatmul, PlaneVecMatInnerProduct, RegisterMatmul},
};
...
///
/// Setup-side methods (problem expansion, blueprint validation, capability
/// queries against a [`ComputeClient`](cubecl::prelude::ComputeClient)) live on
/// `cubek_matmul::components::tile::TileMatmulKind` alongside the matmul
/// blueprint machinery they depend on.
