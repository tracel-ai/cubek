...
impl<Acc: Numeric> Tile<Acc> {
    ...
    pub fn cmma_accumulator<EA: Numeric, EL: Numeric>(
        ...
        self.accumulator_in::<EA, EL>(lhs, comptime!(Instruction::Cmma), monoid)
    }
    ...
    pub fn mma_accumulator<EA: Numeric, EL: Numeric>(
        ...
        self.accumulator_in::<EA, EL>(lhs, comptime!(Instruction::Mma { io }), monoid)
    }
    ...
    pub fn block_accumulator<EA: Numeric, EL: Numeric>(
        ...
        self.accumulator_in::<EA, EL>(lhs, comptime!(Instruction::Registers { config }), monoid)
    }
