...
impl Space {
    ...
    /// ([`MatrixGroups::whole`](crate::MatrixGroups::whole)); call it on the [`final_space`](Space::final_space)
    ...
    ///
    /// A fragment groups its `k` edge by extent alone ([`MatrixGroups::whole`](crate::MatrixGroups::whole)), so
