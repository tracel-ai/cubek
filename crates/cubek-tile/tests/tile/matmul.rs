...
/// The CPU kernel: `c.mm(a, b)` straight on the output, with no accumulator scope around it:
/// what an `InPlace` scope lowers to, spelled by hand. Operands are size-free:
