...
// The same convolutions with the input staged ([`Residence::Auto`]). A gathered operand's region is
...
/// The same resample with `Residence::Auto`: the input tile stages uncompacted into shared
/// memory.
#[test]
