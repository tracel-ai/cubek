...
//! [`cubek_attention::eval::forward::benchmarks::strategies`] ×
//! [`cubek_attention::eval::problem::problems`] through the
//! kernel and compares against the CPU flash-attention v2 reference.
