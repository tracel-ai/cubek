...
use crate::{
    ...
    components::tile::TileAttentionKind, forward::definition::AttentionTileSize,
};
use crate::{
    components::{
        ...
        BlueprintStrategy::Inferred(strategy) => {
            ...
            let map_err = |err| {
                AttentionSetupError::Unavailable(
                    crate::forward::definition::AttentionAvailabilityError::MatmulInstructionUnavailable(
                        err,
                    ),
                )
            };
