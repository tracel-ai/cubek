...
fn test_interpolate_bilinear_identity() {
    ...
    run_interpolate_global_test(client, 5678, -1.0, 1.0, problem, BILINEAR_TOLERANCE);
}
...
fn test_interpolate_bilinear_upsample() {
    ...
    run_interpolate_global_test(client, 1234, -10.0, 10.0, problem, BILINEAR_TOLERANCE);
}
...
fn test_interpolate_bilinear_downsample() {
    ...
    run_interpolate_global_test(client, 91011, -100.0, 100.0, problem, BILINEAR_TOLERANCE);
}
...
fn test_interpolate_bilinear_resize() {
    ...
    run_interpolate_global_test(client, 25, -1.0, 1.0, problem, BILINEAR_TOLERANCE);
}
...
fn test_interpolate_bilinear_without_align_corners() {
    ...
    run_interpolate_global_test(client, 122, -10.0, 10.0, problem, BILINEAR_TOLERANCE);
}
