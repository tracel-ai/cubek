...
fn test_max_pool2d_backward() {
    ...
    let problem = make_problem([4, 4], Shape::from([2, 4, 4, 2]), options);
...
fn test_max_pool2d_backward_strided_no_pad() {
    ...
    let problem = make_problem([6, 6], Shape::from([2, 3, 3, 4]), options);
    run_pool_backward_test(
        client,
        1234,
        -1.0,
...
fn test_max_pool2d_backward_dilated() {
    ...
    let problem = make_problem([8, 8], Shape::from([1, 4, 4, 3]), options);
    run_pool_backward_test(
        client,
        2345,
        -1.0,
...
fn test_max_pool2d_backward_non_square_asymmetric() {
    ...
    let problem = make_problem([5, 7], Shape::from([2, 6, 3, 3]), options);
    run_pool_backward_test(
        client,
        3456,
        -1.0,
...
fn test_max_pool2d_backward_ceil_mode() {
    ...
    let problem = make_problem([5, 5], Shape::from([2, 3, 3, 4]), options);
    run_pool_backward_test(
        client,
        4567,
        -1.0,
