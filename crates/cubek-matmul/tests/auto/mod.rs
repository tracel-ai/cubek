...
//! dispatch, whichever family is compiled behind it. Belongs to neither island,
//! so it lives here rather than under `tiled/` or `multi_level/` — a directory
//! module because a bare `tests/*.rs` would become its own test binary.
