...
mod simple_strided {
    use super::*;
    type Algorithm = cubek_matmul::routines::layered::simple::SimpleAlgorithm<
        TMM,
...
mod simple_barrier_cooperative {
    use super::*;
    type Algorithm = cubek_matmul::routines::layered::simple::SimpleBarrierAlgorithm<
        TMM,
...
mod ordered_double_buffering {
    ...
    type Algorithm =
        cubek_matmul::routines::layered::ordered_double_buffering::OrderedDoubleBufferingAlgorithm<
            TMM,
        >;
...
mod specialized_cyclic {
    ...
    type Algorithm = cubek_matmul::routines::layered::specialized::SpecializedAlgorithm<
        TMM,
