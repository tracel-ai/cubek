mod matmul_plane_accelerated {
    mod cmma {
        ...
        fn launch_simple_strided(
            ...
            test_matmul_strategy(c, p, Strategy::SimpleStridedCmma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_simple_tilewise(
            ...
            test_matmul_strategy(c, p, Strategy::SimpleTilewiseCmma(BlueprintStrategy::Forced(bp)));
        }
        ...
        fn launch_double_buffering_cyclic(
            ...
            test_matmul_strategy(c, p, Strategy::DoubleCyclicCmma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_double_buffering_tilewise(
            ...
            test_matmul_strategy(c, p, Strategy::DoubleTilewiseCmma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_double_buffering_hybrid(
            ...
            test_matmul_strategy(c, p, Strategy::DoubleHybridCmma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_ordered_double_buffering(
            ...
            test_matmul_strategy(c, p, Strategy::OrderedDoubleCmma(BlueprintStrategy::Forced(bp)));
        }
    ...
    mod mma {
        ...
        fn launch_simple_cyclic(
            ...
            test_matmul_strategy(c, p, Strategy::SimpleCyclicMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_simple_strided(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
            ...
            test_matmul_strategy(c, p, Strategy::SimpleStridedMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_simple_tilewise(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
            ...
            test_matmul_strategy(c, p, Strategy::SimpleTilewiseMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_simple_barrier_cooperative(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
        ...
        fn launch_double_buffering_cyclic(
            ...
            test_matmul_strategy(c, p, Strategy::DoubleCyclicMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_double_buffering_tilewise(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
            ...
            test_matmul_strategy(c, p, Strategy::DoubleTilewiseMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_double_buffering_hybrid(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
            ...
            test_matmul_strategy(c, p, Strategy::DoubleHybridMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_ordered_double_buffering(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
            ...
            test_matmul_strategy(c, p, Strategy::OrderedDoubleMma(BlueprintStrategy::Forced(bp)));
        }
        fn launch_specialized_cyclic(
            c: ComputeClient<TestRuntime>,
            p: MatmulProblem,
