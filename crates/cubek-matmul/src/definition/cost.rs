...
pub fn compute_key(client: &ComputeClient, elems: &MatmulElems) -> ThroughputKey {
...
pub fn compute_peak_ops_per_s(client: &ComputeClient, elems: &MatmulElems) -> Option<f64> {
