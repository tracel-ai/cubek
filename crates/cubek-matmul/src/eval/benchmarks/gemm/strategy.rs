...
pub fn strategies() -> Vec<CatalogEntry<Strategy>> {
    vec![
        ...
        cpu_gemm_forced("cpu_gemm_t64", "CpuGemm (forced 64³, maskless on 512)", 64, 2, 2),
        cpu_gemm_forced("cpu_gemm_t48", "CpuGemm (forced 48³, masked on 512)", 48, 2, 2),
        cpu_gemm_forced("cpu_gemm_t32", "CpuGemm (forced 32³, maskless on 512)", 32, 2, 2),
